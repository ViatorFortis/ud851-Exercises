...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESULTS_RAW_JSON_KEY = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String searchUrl = savedInstanceState.get(SEARCH_QUERY_URL_KEY).toString();
            mUrlDisplayTextView.setText(searchUrl);

            String results = savedInstanceState.get(SEARCH_RESULTS_RAW_JSON_KEY).toString();
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putString(SEARCH_QUERY_URL_KEY, searchUrl);
        ...
        outState.putString(SEARCH_RESULTS_RAW_JSON_KEY, results);
    }
}