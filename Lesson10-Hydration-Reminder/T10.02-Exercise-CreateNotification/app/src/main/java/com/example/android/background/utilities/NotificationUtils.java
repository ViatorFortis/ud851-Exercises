...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTETN_ID = 3417;
    ...
    public static void remindUserBeforeCharging(Context context) {
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(
                context,
                WATER_REMINDER_PENDING_INTETN_ID,
                startActivityIntent,
