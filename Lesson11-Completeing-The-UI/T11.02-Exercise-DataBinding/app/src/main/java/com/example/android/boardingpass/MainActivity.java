...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long totalMinuteUntilBoarding = info.getMinutesUntilBoarding();
        long hoursUntilBoarding = TimeUnit.MINUTES.toHours(totalMinuteUntilBoarding);
        long minutesLessHoursUntilBoarding = totalMinuteUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);
